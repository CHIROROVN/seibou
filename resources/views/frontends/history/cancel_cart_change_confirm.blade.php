  ...
  <div class="col-md-9 content-right"><span style="font-size:20px; font-weight: bold; border-bottom: solid 2px #14578b; color: #14578b; ">変更最終確認</span><p style="color: red;font-size:1.1em;"><b>変更処理はまだ完了していません。</b></p>
    ...
    <div class="row mar-bottom30">
      <div class="col-md-12 text-center">
        <input onclick="history.back()" value="もどる" type="button" class="btn btn-sm btn-primary"><br><button onclick="location.href='{{ route('front.history.cancel.cart_change.end') }}'" value="" type="button" class="btn btn-sm btn-primary " style="font-size: 1.2em; background-color: #FF9326; margin-top:10px; border:solid 1px #D96C00;">変更する</button>
      </div>
    </div>
    </form>

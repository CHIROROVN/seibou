...
@section('content')
  ...
  <div class="col-md-9 content-right">
            ...
            <h1>発注内容<span class="small_text">（こちらの内容は納品書に印字されます）</span><span style="float:right;"><input onclick="location.href='{{ route('front.history.cart_change') }}'" value="発注内容の変更" type="button" class="btn btn-sm btn-primary" style="border-radius:0px;text-decoration:underline;"></span></h1>
            ...
            <h1>得意先担当者情報<span class="small_text">（こちらの内容は納品書に印字されます）</span><span style="float:right;"><input onclick="location.href='{{ route('front.history.staff_change') }}'" value="得意先担当者の変更" type="button" class="btn btn-sm btn-primary mar-left40" style="border-radius:0px;text-decoration:underline;"></span></h1>
            ...
            <h1><span style="">メッセージ及び発送方法・発送日時指定<br><span class="small_text">（こちらの内容は納品書に印字されません）</span><span style="float:right;"><input onclick="location.href='{{ route('front.history.message_change') }}'" value="メッセージ及び発送方法・発送日時指定の変更" type="button" class="btn btn-sm btn-primary mar-left40" style="border-radius:0px;text-decoration:underline;"></span></span></h1>
            <table class="table table-bordered table-regist">
              <tbody>
                <tr>
                  <td class="col-title" width="328px">メッセージ<br>
                    <span style="font-size: 0.8em;">＊発送方法等でご要望がある際にお使いください。</span>
                  </td>
                  <td>
                    {!! nl2br($history->自由欄) !!}
                  </td>
            ...
            <h1>納入先<span style="float:right;"><input onclick="location.href='{{ route('front.history.order_change') }}'" value="納入先の変更" type="button" class="btn btn-sm btn-primary mar-left40" style="border-radius:0px;text-decoration:underline;"></span></h1>
            <table class="table table-bordered table-regist">
              <tbody>
                <tr>
      ...
      {!! Form::open(array('route' => ['front.history.detail'], 'method' => 'get', 'enctype'=>'multipart/form-data')) !!}

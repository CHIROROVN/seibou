...
<!-- CONTENT -->
          <div class="col-md-9 content-right">
            <h1>納入先リストの詳細</h1>
            <p class="text-orange">以下の納入先リストを削除しますか？　この操作は取り消すことができません。</p>
            ...
            <div class="row mar-bottom30">
              <div class="col-md-12 text-center">
                <input onclick="location.href='{{route('front.delivery.detail', $delivery->delivery_id)}}'" value="やめる" type="button" class="btn btn-sm btn-primary">
                <input onclick="location.href='{{route('front.delivery.delete', $delivery->delivery_id)}}'" value="削除する" type="button" class="btn btn-sm btn-primary mar-left40">
              </div>
            </div>
            <div class="row mar-bottom30">
              <div class="col-md-12 text-center">
